...
**Mean of the total number of steps per day is `r mean(steps_per_day, na.rm=TRUE)` ,and median is `r median(steps_per_day, na.rm=TRUE)` **
...
**Relatively more foot steps over the weekend**
